...
class GamepadActions:
    """Actions for the Gamepad classes. These provide methods for the special walking on the spot + gamepad modes."""
    ...
    def set_displays(self, extremity_list: List[str]):
        ...
        if not self._circles_displaying:
            self._extremity_circles.set_extremity_circles_dict(extremity_list) #add full gamepad
